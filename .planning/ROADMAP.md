...
- [ ] **Phase 8: Packaging** - Hand-written `debian/` → lintian-clean `.deb` + `install.sh` fallback + bundled single-file CLI (source/static execution complete 2026-05-23; Linux package UAT pending)
...
Plans:
- [x] 04-01-PLAN.md — Profile control panel + read-back state machine + Phase 4 smoke runner (covers GUI-05..07)
...
Plans:
- [x] 05-01-PLAN.md — Live sensor panel + focused/unfocused notifications + Phase 5 smoke runner (covers SENS-01..04, NOTI-01..02)
...
- [x] 06-02-PLAN.md — GUI boot service panel + startup/first-write wait guard (covers BOOT-03..04)
- [x] 06-03-PLAN.md — login1 resume subscription + last-selected profile reapply (covers BOOT-05)
...
- [x] 07-02-PLAN.md — Separate GTK3 Ayatana tray helper process + quick-switch menu + Show AcerControl (covers TRAY-01, TRAY-03)
- [x] 07-03-PLAN.md — Hardware compatibility fixtures + TRAY-04 packaging handoff + Phase 7 UAT checklist (covers TRAY-04, HW-01, HW-02)
...
- [x] 08-04-PLAN.md — package build/lintian/no-pyc/VM install closeout + final Phase 1-8 regression (covers PKG-05, PKG-06, PKG-07)
