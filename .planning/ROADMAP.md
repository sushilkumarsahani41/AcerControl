...
- [ ] **Phase 7: Tray Helper + Hardware Compatibility** - Separate GTK3 `acercontrol-tray` process + degrade gracefully on non-PHN16-72 (in progress; 07-01 and 07-02 complete)
...
| 7. Tray Helper + Hardware Compatibility | 2/3 | In Progress | - |
